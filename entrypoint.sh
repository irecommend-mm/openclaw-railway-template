...
# gog expects ~/.config/gogcli (not ~/.config/gog).
# Keep HOME as /home/openclaw; only mirror ~/.config/gogcli to /data.
...
ln -sfn /data/.config/gogcli /home/openclaw/.config/gogcli
